      ...
      <div className="mx-auto max-w-7xl px-6 py-14 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><a href="#how" className="hover:text-foreground">{t("footer_how")}</a></li>
            <li><a href="#products" className="hover:text-foreground">{t("footer_products")}</a></li>
            <li><Link to="/register" className="hover:text-foreground">{t("footer_signup")}</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><a href="#faq" className="hover:text-foreground">{t("footer_faq")}</a></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-border py-5 text-center text-xs text-muted-foreground">{t("footer_copy")}</div>
    </footer>
  );
}
