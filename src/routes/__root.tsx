  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <a href="/" className="inline-flex items-center justify-center rounded-xl bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join Droblow Affiliate and start earning by promoting physical products across Algeria. Zero stock, zero shipping." },
      { property: "og:title", content: "Droblow Affiliate" },
      { property: "og:description", content: "Sell without stock. Earn from every delivered order." },
